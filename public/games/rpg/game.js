...
const ui = {
    ...
    // gameOverScreen: document.getElementById('game-over'), // To be added later
...
function showScreen(screenId) {
    ...
    switch(screenId) {
        case 'title':
            ui.titleScreen.style.display = 'flex'; // Use flex to center content
            break;
        case 'game':
            ui.gameScreen.style.display = 'block';
            resetGame();
            break;
        // Other cases for options, etc. will be added here
    }
}
